...
export default init => {
  let sequelize = Database.getConnection();
    ...
    /**
      ...
      * ------------------------------------
      */
    class BakeryBasket extends Sequelize.Model{}
    BakeryBasket.init({
        _id: { 
      ...
      */
      ...
      { sequelize, tableName: "bakerybasket", timestamps: false }
    );
    ...
    BakeryBasket.belongsToMany(User, {
          through: "BakeryBasket_Shubham",
        as: "Shubham",
        foreignKey: "id_BakeryBasket",
        otherKey: "id_User",
        timestamps: false
    });
