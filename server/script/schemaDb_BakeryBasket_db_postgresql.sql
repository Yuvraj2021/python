...
CREATE DATABASE bakerybasket_db;
...
-- relation 1:m Shubham BakeryBasket - identity
ALTER TABLE "bakerybasket" ADD COLUMN "identity" INTEGER REFERENCES "identity"(_id);

-- relation m:m Shubham BakeryBasket - User
CREATE TABLE IF NOT EXISTS "BakeryBasket_Shubham" (
    "_id" SERIAL PRIMARY KEY,
    "id_BakeryBasket" INTEGER  NOT NULL REFERENCES "bakerybasket"(_id),
